...
unique(sel.sppDens.nona$clean_taxonomy) #391 taxa after selection with the 529 selected taxonary taxa - why?
...
```{r}
write.csv(sel.sppDens.nona, file=file.path(dataPath,(paste0("activeSpeciesfilter_", Sys.Date(),".csv"))))
```
